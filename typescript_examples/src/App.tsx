const App = () => {
  ...
  console.log(name, surname, age, isAdult, wife, favoriteColor, numbers, items, item, addedNumber);
  ...
  console.log(title, subTitle, peopleCount, maxPeopleCount, isOpen, openTime, closeTime, security);
